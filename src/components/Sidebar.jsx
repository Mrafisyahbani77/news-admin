            ...
            <nav id="sidebarMenu" className="sidebar d-lg-block bg-tertiary text-white collapse" data-simplebar>
                <div className="sidebar-inner px-3 pt-3">
                    ...
                    <ul className="nav flex-column pt-3 pt-md-0">
                        ...
                        {hasAnyPermission(['sliders.index']) &&
                            <li className={activeRoute[1] === "reports" ? "nav-item mt-2 active" : "nav-item mt-2"}>
                                <Link to="/reports" className="nav-link d-flex justify-content-between">
                                    <span>
                                        <span className="sidebar-icon">
                                            <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" fill="currentColor" className="bi bi-file-text-fill" viewBox="0 0 16 16">
                                                <path d="M2 0h9a2 2 0 0 1 2 2v12a2 2 0 0 1-2 2H2a2 2 0 0 1-2-2V2a2 2 0 0 1 2-2zm8.5 1a.5.5 0 0 0 0 1h1.79l-2.45 2.45a.5.5 0 0 0 .35.85H13.5a.5.5 0 0 0 0-1h-1.79l2.45-2.45a.5.5 0 0 0-.35-.85H10.5z" />
                                                <path d="M4 5.5a.5.5 0 0 1 .5-.5h7a.5.5 0 0 1 0 1h-7a.5.5 0 0 1-.5-.5zM4 8a.5.5 0 0 1 .5-.5h7a.5.5 0 0 1 0 1h-7a.5.5 0 0 1-.5-.5zM4 10.5a.5.5 0 0 1 .5-.5h3a.5.5 0 0 1 0 1h-3a.5.5 0 0 1-.5-.5z" />
                                            </svg>
                                        </span>
